...
const FullServiceFund = () => {
  ...
  return (
    <FullServiceFundPageWrapper className={theme}>
      ...
      <img className="image" src="fullservicefund.gif" alt="Full Service Fund"/>
      ...
      <NavLink to="/#contact">
        <button className='button'> Drop us your Query </button>
      </NavLink>
