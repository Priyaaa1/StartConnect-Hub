...
const SheSpark = () => {
  return (
    <Content>
      <Heading>Welcome To SheSpark Innovations!</Heading>
      <Image src="/src/assets/project-3.jpg" alt="SheSpark Innovations" className="logImg" />
      <br />
      ...
      <p>
        ...
        broader market. SheSpark Innovations is a socially conscious startup dedicated to revolutionizing the gifting
      ...
      <List>
        <li>Launch of SheSpark Innovations website and online store</li>
