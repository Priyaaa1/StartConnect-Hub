...
const ActionProvider = ({ createChatBotMessage, setState, children }) => {
  ...
  const handleHello = () => {
    const message = createChatBotMessage(
      "Hello , I am InvestIQ , type in your query.."
    );
  ...
  const contactUs = () => {
    const message = createChatBotMessage(
      "Contact details can be viewed on our CONTACT US section, Feel free to drop us your query"
    );
    updateState(message, contactUs);
  };
  const abchandle = () => {
    const message = createChatBotMessage(
      "Please write relevant message😥!"
    );
    updateState(message, contactUs);
  };
  const emptyHandle = () => {
    const message = createChatBotMessage(
      "You forgot to write, please type your message first🙂!"
    );
    updateState(message, contactUs);
  };
