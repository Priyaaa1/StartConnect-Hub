        ...
        <div className='footer-half footer-sections'>
          <div className='footer-2'>
            ...
            <ul className='footer-links'>
              <li className='footer-link'>
                <a onClick={() => handleNavigation("/#about", "about")}>About Us</a>
              </li>
          ...
          <div className='footer-2'>
            ...
            <ul className='footer-links'>
              ...
              <li className='footer-link'>
                <a onClick={() => handleNavigation("/#testimonials", "testimonials")}>Testimonials</a>
              </li>
              <li className='footer-link'>
                <a onClick={() => handleNavigation("/#accordian", "accordian")}>FAQ</a>
              </li>
              <li className='footer-link'>
                <a onClick={() => handleNavigation("/howitworks", "howitworks")}>How it Works</a>
              </li>
              <NavLink to="/feedback">
